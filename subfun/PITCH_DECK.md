...
- 📉 No way to unlock creativity
- 🔒 Guardrails limit potential

**Users want:**
- 🎨 Creative, unexpected outputs
- 💡 Different cognitive modes
- 🎭 Customizable AI personalities
- ⚡ Choice in how AI thinks
...
- **SOUL.md** → Personality, tone, writing style
- **TOOLS.md** → Preferred reasoning methods, tool preferences
- **HEARTBEAT.md** → Default behavior patterns
...
**Withdrawal:** Effects wear off → Files revert to baseline → The crash is real
